 ...
 * Twiter, etc.
 * @see https://firebase.facebook.com/docs/reference/js/firebase.auth.AuthProvider
 * 
 ...
 * de Google,
 * @see https://firebase.facebook.com/docs/reference/js/firebase.auth.FacebookAuthProvider
 * 
 * @typedef {Object} FacebookAuthProvider
 ...
 * usuarios.
 * @see https://firebase.facebook.com/docs/reference/js/firebase.auth.Auth
 * 
 * @typedef {Object} Auth
...
/**
 * @see https://firebase.facebook.com/docs/reference/js/firebase.firestore.DocumentSnapshot
 * 
...
/**  https://firebase.facebook.com/docs/reference/js/firebase.firestore.DocumentReference
...
/** https://firebase.facebook.com/docs/reference/js/firebase.firestore.QuerySnapshot
 * @typedef {Object} 	QuerySnapshot
 * @property {number} size 
 * @property {(f:(d:DocumentSnapshot)=>any)=>void} forEach los documentos existen
 */

/** https://firebase.facebook.com/docs/reference/js/firebase.firestore.Query
 * @typedef {Object} Query
 * @property {(n:(snap: QuerySnapshot)=>void, e:(e:Error)=>void)=>void} onSnapshot 
 * @property {()=>Promise<QuerySnapshot>} get
 */

/** https://firebase.facebook.com/docs/reference/js/firebase.firestore.CollectionReference
...
/** https://firebase.facebook.com/docs/reference/js/firebase.firestore.Firestore
 * @typedef {Object} Firestore
 * @property {(ruta:string)=>CollectionReference} collection
 */

/** https://firebase.facebook.com/docs/reference/js/firebase.storage.Reference
...
/** https://firebase.facebook.com/docs/reference/js/firebase.storage.Storage
